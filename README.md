...
Télécharger le binaire précompilé dans les [releases](https://github.com/bakraw/k-means-compression/releases) ou compiler la source (**s'assurer que CMake et OpenCV sont installés sur votre machine**).
...
- implémenter ma propre version des typedefs de vecteurs de OpenCV (```cv::Vec3f```, etc.) et éventuellement de cv::Mat qui sont assez lents et incompatibles avec certaines fonctionnalités de OpenMP.
